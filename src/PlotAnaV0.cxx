...
void PlotAnaV0::Make(){
	...
	TH1D* h3 = (TH1D*)histFile->Get("hInvMassTof1AfterPicking1");
	TH1D* h4 = (TH1D*)histFile->Get("hInvMassTof2AfterPicking1");
...
void PlotAnaV0::fitK0s(Double_t minRange, Double_t maxRange, int numBins, bool is2TOF) {
...
void PlotAnaV0::fitLambda(Double_t minRange, Double_t maxRange, int numBins, bool is2TOF) {
...
double PlotAnaV0::GoodnessOfFit(RooPlot*& frame, RooAddPdf& model, RooDataHist& data){
...
TString PlotAnaV0::convertToString(double val) {
...
int PlotAnaV0::makeInt(double val) {
	int result = val;
	return result;
}


vector<pair<int,double>> PlotAnaV0::effFit(int Switch ,double Min, double Max,Double_t signalGuess1, Double_t signalGuess2, Double_t polGuess1[2], Double_t polGuess2[2], int runSeparatePions){
...
void PlotAnaV0::efficiency(int switcher, int runSeparatePions = 0) {
...
void PlotAnaV0::invMassLambda(Double_t minRange, Double_t maxRange, int numBins, bool is2TOF){
...
void PlotAnaV0::invMassK0s(Double_t minRange, Double_t maxRange, int numBins, bool is2TOF){
	//TCanvas* canvas;
