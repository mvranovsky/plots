...
class PlotV0SingleState : public Plot {
    ...
    private:
		...
		vector<pair<int,double>> effFit(int Switch ,double Min, double Max,Double_t signalGuess1, Double_t signalGuess2, Double_t polGuess1[2], Double_t polGuess2[2]);
